...
|--------|------|------|------|
| POST | /auth/register | No | email, password, firstName, lastName, workshopName |
...
`FRONTEND_URL` env (virgülle ayrılmış origin listesi). Default: `http://localhost:3022`.
